...
namespace GameEngine.DemoGame
{
    public class DemoGame : Engine
    {
        ...
        {   
            ...
            player = new Shape(new Vector2(250, 250), new Vector2(20, 20), "Player", Color.Red);
            rect = new Shape(new Vector2(150, 150), new Vector2(100, 100), "rect", Color.Cyan);
            boarder = new Shape(new Vector2(500,0), new Vector2(5,1000), "boarder", Color.Black);
            boarder2 = new Shape(new Vector2(0, 500), new Vector2(1000, 5), "boarder", Color.Black);
